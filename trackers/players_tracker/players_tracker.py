...
class PlayerTracker(Tracker):
    ...
    def predict_sample(self, sample: Iterable[np.ndarray], **kwargs) -> list[Players]:
        ...
        results = self.model.predict(
            ...
            imgsz=self.IMGSZ,
            device=self.DEVICE,
            classes=[0],  # Class 0 is usually 'person' in YOLO
        )
